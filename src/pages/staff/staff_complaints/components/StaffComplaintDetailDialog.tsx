...
interface StaffComplaintDetailDialogProps {
  isOpen: boolean;
  onClose: () => void;
  complaintId: string | null;
}

export default function StaffComplaintDetailDialog({
  isOpen,
  onClose,
  complaintId
}: StaffComplaintDetailDialogProps) {
                ...
                {complaint.adminResponse ? (
                  ...
                  <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    ...
                    <p className="text-sm text-gray-400 mt-1">
                      Your report is being reviewed. You will be notified once admin responds.
                    </p>
                  </div>
                )}
              </div>
