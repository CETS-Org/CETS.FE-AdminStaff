...
import { getUserInfo, getCurrentUserId } from "@/lib/utils";
import { createComplaint, getReportTypes, getReportStatuses, getReportImageUploadUrl, type CreateComplaintRequest } from "@/api/complaint.api";
import { uploadToPresignedUrl } from "@/api/file.api";
import { useToast } from "@/hooks/useToast";

interface SystemReportPopupProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: () => void;
}
...
const SystemReportPopup: React.FC<SystemReportPopupProps> = ({
  isOpen,
  onClose,
  onSubmit,
}) => {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 p-4 rounded-lg">
              ...
              <p className="text-sm text-blue-800 font-medium">
                {userInfo?.fullName || userInfo?.email || "Staff"}
              </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-orange-700">
                    Your report will be reviewed by admin staff. High priority issues are addressed within 24 hours. 
                    You will be notified once your report has been reviewed.
                  </p>
                </div>
              </div>
            </div>
...
export default SystemReportPopup;
