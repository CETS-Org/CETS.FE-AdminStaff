...
export const api = {
  ...
  // Authentication
  loginAcademicStaff: (credentials: any, config?: AxiosRequestConfig) => 
    apiClient.post('/api/IDN_Account/login/academicStaff', credentials, config),
  
  loginAccountantStaff: (credentials: any, config?: AxiosRequestConfig) => 
    apiClient.post('/api/IDN_Account/login/accountantStaff', credentials, config),

  loginAdmin: (credentials: any, config?: AxiosRequestConfig) => 
    apiClient.post('/api/IDN_Account/login/admin', credentials, config),
};
