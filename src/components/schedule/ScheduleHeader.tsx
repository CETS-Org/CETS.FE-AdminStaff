...
export default function ScheduleHeader({
  ...
  return (
    <div className="flex items-center justify-between p-6 border-b border-accent-200">
      ...
      {/* Calendar Button */}
      <button
        className="inline-flex items-center gap-2 bg-accent-400 hover:bg-accent2-600 text-white px-4 py-3 rounded-lg text-sm font-medium shadow-md transition-all duration-200"
