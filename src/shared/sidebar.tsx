...
export default function Sidebar({ isOpen }: { isOpen: boolean }) {
    ...
    //   )}>
          <div className={cn(
        "fixed top-0 left-0 z-40 w-64 bg-white shadow-xl p-4  transition-transform duration-300 h-screen",
        "lg:translate-x-0 lg:block ",
        isOpen ? "translate-x-0" : "-translate-x-full"
      )}>
            <div className="h-16 fixed bg-white w-full top-0 left-0 flex items-center px-4 border-b border-neutral-200">
            ...
            <h2 className="font-bold mt-4">Upcoming Deadlines</h2>
            <div className=" h-[30vh] mt-auto mb-4 bot-0 bg-white w-full px-2 overflow-y-auto scrollbar-hide">                
